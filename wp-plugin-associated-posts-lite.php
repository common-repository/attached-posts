...
class wp_plugin_associated_posts {
  ...
  function Register_Widgets(){
    Register_Widget('wp_widget_associated_posts');
  }
  ...
  function Add_Post_Meta_Boxes(){
    ...
    WP_Enqueue_Script('associated-posts-meta-box', $this->base_url . '/meta-box.js', Array('jquery'), Null, True);
  }
  ...
  function Save_Meta_Box($post_id){
    ...
    If (IsSet($_POST[ __CLASS__ ]) && Is_Array($_POST[__CLASS__])){
      # Save Meta data
      update_post_meta ($post_id, '_' . __CLASS__, $_POST[ __CLASS__ ]);
    }
  }
...
class wp_widget_associated_posts Extends WP_Widget {
  var $arr_option; # Widget settings of this instance
  var $AP; # Pointer to the global Associated Posts Plugin object
  ...
  function Form ($options){
    ...
    <?php Else : ?>
      ...
      <p>
        ...
        <input type="text" name="<?php Echo $this->get_field_name('title')?>" id="<?php Echo $this->get_field_id('title')?>" value="<?php Echo $this->get_option('title')?>" class="widefat">
      </p>
